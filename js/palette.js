...
"#fe9800","#fdc689","#00aef0","#6dd0f7","#662d91","#a186be", "#534741","#754c24","#ed008c","#ee145b","#640000","#646400" ,"#006400", "#000064", 
...
myPalette.style.display = 'block'; //changed "block" to "inline"
...
myPreview.style.color = myValue.value;
myPreview.style.borderBottomColor = myValue.value;
if(myValue.value == "#ffffff"){
    myPreview.style.backgroundColor = "#aaaaaa";
} else {
    myPreview.style.backgroundColor = "transparent";
